...
请在邮件中简要说明您的应用场景（如 AI 训练、推理、PoC、OEM 配套等）、目标配置、预计数量与期望交期，以便我们更快为您匹配资源与方案。
...
我们提供型号确认、替代选型建议、供应链协同及交期沟通支持。具体产品规格、价格与可用性以商务沟通确认为准。

## 响应说明

我们会在工作日内尽快回复您的咨询。对于紧急项目需求，请在邮件标题注明「紧急」及期望回复时间。
